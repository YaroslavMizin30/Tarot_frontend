...
export const TAROT_CARD_TRANSLATIONS_RU: Record<CardName, string> = {
  // Старший Аркан
  ...
  // Пентакли
  [CardName.ACE_OF_PENTACLES]: 'Туз Пентаклей',
  [CardName.TWO_OF_PENTACLES]: 'Двойка Пентаклей',
  [CardName.THREE_OF_PENTACLES]: 'Тройка Пентаклей',
  [CardName.FOUR_OF_PENTACLES]: 'Четверка Пентаклей',
  [CardName.FIVE_OF_PENTACLES]: 'Пятерка Пентаклей',
  [CardName.SIX_OF_PENTACLES]: 'Шестерка Пентаклей',
  [CardName.SEVEN_OF_PENTACLES]: 'Семерка Пентаклей',
  [CardName.EIGHT_OF_PENTACLES]: 'Восьмерка Пентаклей',
  [CardName.NINE_OF_PENTACLES]: 'Девятка Пентаклей',
  [CardName.TEN_OF_PENTACLES]: 'Десятка Пентаклей',
  [CardName.PAGE_OF_PENTACLES]: 'Паж Пентаклей',
  [CardName.KNIGHT_OF_PENTACLES]: 'Рыцарь Пентаклей',
  [CardName.QUEEN_OF_PENTACLES]: 'Королева Пентаклей',
  [CardName.KING_OF_PENTACLES]: 'Король Пентаклей',
};
