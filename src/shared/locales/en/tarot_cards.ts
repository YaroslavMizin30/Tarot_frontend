...
export const TAROT_CARD_TRANSLATIONS_EN: Record<CardName, string> = {
  // Major Arcana
  ...
  // Pentacles
  [CardName.ACE_OF_PENTACLES]: 'Ace of Pentacles',
  [CardName.TWO_OF_PENTACLES]: 'Two of Pentacles',
  [CardName.THREE_OF_PENTACLES]: 'Three of Pentacles',
  [CardName.FOUR_OF_PENTACLES]: 'Four of Pentacles',
  [CardName.FIVE_OF_PENTACLES]: 'Five of Pentacles',
  [CardName.SIX_OF_PENTACLES]: 'Six of Pentacles',
  [CardName.SEVEN_OF_PENTACLES]: 'Seven of Pentacles',
  [CardName.EIGHT_OF_PENTACLES]: 'Eight of Pentacles',
  [CardName.NINE_OF_PENTACLES]: 'Nine of Pentacles',
  [CardName.TEN_OF_PENTACLES]: 'Ten of Pentacles',
  [CardName.PAGE_OF_PENTACLES]: 'Page of Pentacles',
  [CardName.KNIGHT_OF_PENTACLES]: 'Knight of Pentacles',
  [CardName.QUEEN_OF_PENTACLES]: 'Queen of Pentacles',
  [CardName.KING_OF_PENTACLES]: 'King of Pentacles',
};
